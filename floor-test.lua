...
currentFloor = FLOORS['CONTROLROOM'] -- start from control room (floor 3)
moveToFloor("REACTORS") -- Move elevator to Reactor room
print(currentFloor) -- should print 2, which indicates the elevator has reached Reactors floor.
